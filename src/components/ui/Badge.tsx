...
const badgeVariants = cva(
  // Plus-Polish: Consistent spacing, semantic tokens, smooth transitions
  'inline-flex items-center justify-center rounded-lg font-medium transition-colors duration-150',
  {
    variants: {
      variant: {
        ...
        danger: 'bg-destructive-background text-destructive border border-destructive/20',
        info: 'bg-info-background text-info border border-info/20',
        accent: 'bg-accent/10 text-accent border border-accent/20',
        solid: 'bg-primary text-primary-foreground border-0 shadow-sm',
