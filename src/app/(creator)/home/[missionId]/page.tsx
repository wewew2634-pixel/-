    ...
    <div className="min-h-screen bg-bg-primary pb-24">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-surface/95 backdrop-blur-md border-t border-border/50 p-4 safe-bottom">
        <div className="max-w-screen-xl mx-auto">
          <button
            className={cn(
              "inline-flex items-center justify-center gap-2 h-14 px-4 rounded-2xl font-semibold text-[15px] transition-all duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-surface disabled:opacity-50 disabled:cursor-not-allowed disabled:pointer-events-none active:scale-[0.98] w-full bg-primary text-primary-foreground shadow-lg hover:brightness-105 hover:shadow-xl hover:-translate-y-0.5",
              mission.stats.remainingSlots === 0 && "bg-surface-2 text-foreground border border-border hover:bg-surface-hover hover:border-primary/30 shadow-none hover:shadow-none hover:translate-y-0"
            )}
      ...
      >
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            <button
              className="inline-flex items-center justify-center gap-2 h-14 px-4 rounded-2xl font-semibold text-[15px] transition-all duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-surface disabled:opacity-50 disabled:cursor-not-allowed disabled:pointer-events-none active:scale-[0.98] w-full bg-primary text-primary-foreground shadow-lg hover:brightness-105 hover:shadow-xl hover:-translate-y-0.5"
              onClick={handleApply}
              disabled={isApplying}
              aria-label="미션 신청 확인"
            >
            ...
            <button
              className="inline-flex items-center justify-center gap-2 h-14 px-4 rounded-2xl font-semibold text-[15px] transition-all duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-surface disabled:opacity-50 disabled:cursor-not-allowed disabled:pointer-events-none active:scale-[0.98] w-full bg-transparent text-muted border border-border hover:bg-surface/50 hover:border-primary/50 hover:text-foreground"
