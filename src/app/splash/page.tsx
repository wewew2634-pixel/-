...
export default function SplashPage() {
  ...
  return (
    <div className="min-h-screen bg-bg-primary flex flex-col items-center justify-center px-5 animate-fade-in">
      {/* Logo */}
      <div className="w-[100px] h-[100px] bg-gradient-to-br from-primary to-secondary rounded-2xl flex items-center justify-center text-5xl mb-6 animate-scale-in shadow-primary">
        찍
      </div>

      {/* Title */}
      <h1 className="text-display-lg font-bold mb-2 text-text-primary">
        찍먹
      </h1>
