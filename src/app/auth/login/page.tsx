  ...
  return (
    <div className="min-h-screen bg-bg-primary flex flex-col px-5 py-8 animate-fade-in">
      ...
      <div className="text-center mb-12 pt-8">
        {/* Logo */}
        <div className="w-20 h-20 bg-gradient-to-br from-primary to-secondary rounded-[20px] flex items-center justify-center text-[40px] mx-auto mb-4 animate-scale-in shadow-primary">
          찍
        </div>
        
        {/* Welcome Text */}
        <h1 className="text-h1 font-bold mb-2 whitespace-pre-line text-text-primary">
          찍먹에 오신 것을{'\n'}환영합니다
        </h1>
      ...
      <div className="flex-1 flex flex-col gap-3">
        ...
        <Button
          ...
          className="bg-[#000000] hover:bg-[#222222] border-0"
        ...
        <Button
          ...
          className="bg-[#FF0000] hover:bg-[#CC0000] border-0"
