  ...
  return (
    <div className="min-h-screen bg-bg-primary flex flex-col px-5 py-8 animate-fade-in">
      ...
      <div className="text-center mb-12 pt-8">
        {/* Logo */}
        <div className="w-20 h-20 bg-gradient-to-br from-primary to-secondary rounded-[20px] flex items-center justify-center mx-auto mb-4 animate-scale-in shadow-primary">
          <span className="text-[32px] font-black text-white tracking-tight">JM</span>
        </div>
        
        {/* Welcome Text */}
        <h1 className="text-h1 font-black mb-2 text-text-primary tracking-tight">
          Welcome to JJIKMEOK
        </h1>
