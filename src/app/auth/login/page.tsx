  ...
  return (
    <div className="min-h-screen bg-bg-primary flex flex-col px-5 py-8 animate-fade-in">
      ...
      <div className="text-center mb-12 pt-8">
        {/* Logo */}
        <div className="w-20 h-20 bg-gradient-to-br from-primary to-secondary rounded-xl flex items-center justify-center text-display-xl mx-auto mb-4 animate-scale-in shadow-primary">
          찍
        </div>
