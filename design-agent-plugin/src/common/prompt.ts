...
### Rules
1. Extract ALL distinct colors, spacing, and radius values.
2. Create Semantic Tokens (e.g., "sys-bg-primary") referencing the Primitives.
3. Define Typography styles.
4. Do NOT generate any components.
`;
